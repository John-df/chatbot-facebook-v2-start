	...
	switch (action) { // ATTENTION REtirer espace + indenter comme il faut + changer detailed-application par nom de mon action
		...
		case "Espace_Travail_Request_Validation":
				   // let date= dateFormat(now,"isoDate");
				    let categorie=contexts[1].parameters.fields['Espace_confort'];
				    let commentaire=contexts[1].parameters.fields['description'];
				    let batiment=contexts[1].parameters.fields['batiment']+contexts[1].parameters.fields['etage'];
