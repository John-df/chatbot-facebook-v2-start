	...
	switch (action) { // ATTENTION REtirer espace + indenter comme il faut + changer detailed-application par nom de mon action
		...
		case "Espace_Travail_Request_Validation":
				   // let date= dateFormat(now,"isoDate");
				    ...
				    let commentaire=contexts['espace_travail_request-followup-2'].parameters.fields['description'];
				    let batiment=contexts['espace_travail_request-followup-2'].parameters.fields['batiment']+contexts['espace_travail_request-followup-2'].parameters.fields['etage'];
